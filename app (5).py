...
with col1:
    ...
    date_sinistre = st.date_input("Date sinistre", value=None, label_visibility="visible")
with col2:
    ...
    date_effet = st.date_input("Date d'effet", value=None, label_visibility="visible")

date_echeance = st.date_input("Date d’échéance", value=None, label_visibility="visible")

if st.button("📥 Calculer et valider"):
    ...
    st.download_button("⬇️ Télécharger le fichier Excel", data=buffer.getvalue(), file_name=fichier_excel, mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
